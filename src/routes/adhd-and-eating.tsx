    ...
    <div className="min-h-dvh bg-[var(--oat)] text-[var(--plum)]">
      ...
      <main id="main-content" tabIndex={-1}>
        ...
        <section className="relative overflow-hidden bg-[var(--plum)] text-[var(--oat)]">
          ...
          <div className="mx-auto max-w-3xl px-5 py-20 md:py-28">
            ...
            <p className="mt-8 max-w-[62ch] font-display text-xl italic leading-snug text-[var(--oat)]/90 md:text-2xl">
              If your relationship with food has always felt harder and stranger than it seems to be for other people, and no one has ever connected it to your ADHD, this guide is for you. It is the honest, whole picture, and it is written to be safe for anyone who has ever struggled with eating.
            </p>
          </div>
        </section>
        ...
        <article className="mx-auto max-w-3xl px-5 py-16 md:py-24">
          ...
          <P>
            The thread that ties them together is interoception, the sense that reads the signals coming from inside your body, hunger and fullness among them. For a great many people with ADHD, those signals arrive faint, or late, or all at once, so the quiet mid-morning &ldquo;I could eat&rdquo; never quite registers, and by evening the volume is turned all the way up. On top of that, ADHD is, at its core, a difference in regulation, of attention, emotion and impulse, and eating sits squarely inside that. Food can become a way to reach for calm, or focus, or a hit of interest when a day feels flat. And if you take stimulant medication, its appetite-suppressing effect during the day is well established, which quietly pushes eating to the edges of the evening. None of these are flaws. They are the predictable results of how the brain is wired.
          </P>
          ...
          <P>
            Forgetting to eat all day, then eating everything by night. This is the interoception story in action, a hunger signal that stays quiet until it is urgent, so the day's missed meals arrive together after dark.{" "}
            <Link to="/letters/why-a-brain-like-ours-forgets-to-eat" className="underline decoration-[var(--terracotta)] underline-offset-4 hover:text-[var(--terracotta)]">
              Why a brain like ours forgets to eat
            </Link>
            .
          </P>
          <P>
            Eating for stimulation, not just hunger. When a brain runs on interest and dopamine, food can become one of the easiest and most available sources of both, especially when you are bored, understimulated, or trying to switch tasks.
          </P>
          <P>
            Eating to soothe big feelings. Because emotion regulation sits at the centre of ADHD, food can become a way to manage a nervous system that runs loud. This is human and common, and it responds far better to understanding than to restriction.
          </P>
          <P>
            Sensory complexity around food. For many people, and especially those who are also autistic, texture, smell and the feel of particular foods matter enormously, so a &ldquo;balanced plate&rdquo; can be genuinely difficult for reasons that have nothing to do with fussiness. See{" "}
            <Link to="/letters/audhd-autistic-and-adhd" className="underline decoration-[var(--terracotta)] underline-offset-4 hover:text-[var(--terracotta)]">
              the AuDHD letter
            </Link>
            .
          </P>
          ...
          <P>
            ...
            <Link to="/letters/eating-by-the-clock-not-by-hunger" className="underline decoration-[var(--terracotta)] underline-offset-4 hover:text-[var(--terracotta)]">
              a full letter on this
            </Link>
            , and{" "}
            <Link to="/anchor" className="underline decoration-[var(--terracotta)] underline-offset-4 hover:text-[var(--terracotta)]">
              the Anchor app
            </Link>{" "}
          ...
          <P>
            Working with sensory needs, not against them. Safe foods are not a failure. Building from the textures and tastes that actually work for you, and adding gently from there, is far kinder and far more effective than forcing a &ldquo;balanced plate&rdquo; that your nervous system rejects.
          </P>
          <P>
        ...
        <section className="mx-auto max-w-3xl px-5 py-14">
          <div className="rounded-2xl border border-[var(--plum)]/10 bg-[var(--cream)] p-6 text-sm leading-relaxed text-[var(--plum)]/80 md:p-8">
            <p>
              If any of this has stirred something difficult, please reach out for support. In an emergency call <strong className="text-[var(--plum)]">000</strong>. For free help any time you can call Lifeline on <strong className="text-[var(--plum)]">13 11 14</strong>, or the Butterfly Foundation's eating disorders line on <strong className="text-[var(--plum)]">1800 33 4673</strong> (1800 ED HOPE).
            </p>
          </div>
        </section>
      </main>
