      ...
      <main id="main-content" tabIndex={-1}>
            ...
            <div className="grid items-center gap-10 md:grid-cols-[1.1fr_0.9fr] md:gap-14">
              <div>
                ...
                <p className="mt-6 font-display text-xl italic text-[var(--oat)]/85 md:text-2xl">
                  Support should feel like belonging.
                </p>
              </div>
        ...
        <section className="bg-[var(--cream)]">
          <div className="mx-auto max-w-4xl px-5 py-16 md:py-24">
            ...
            <div className="mt-10 grid gap-5 md:grid-cols-3">
              {[
                {
                  title: "No explaining yourself first",
                  body: "We reduce assumptions and ask what respectful, accessible and identity-affirming support means to you.",
                },
                {
                  title: "Evidence with its limits visible",
                  body: "Guidelines, research, clinical lenses and lived experience are labelled rather than blended into one claim.",
                },
                {
                  title: "Scope before ego",
                  body: "The clinic provides therapy and support. It does not diagnose ADHD or prescribe medication, and it refers when another discipline is needed.",
                },
              ].map((item) => (
                <article
                  key={item.title}
        ...
        <section className="mx-auto max-w-3xl px-5 py-16 md:py-24">
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            ...
            <Link
              to="/approach"
              className="inline-flex min-h-11 items-center rounded-full border border-[var(--plum)] px-6 py-3 text-sm"
            >
