    ...
    <div className="min-h-dvh bg-[var(--oat)] text-[var(--plum)]">
      ...
      <main id="main-content" tabIndex={-1}>
        ...
        <article className="mx-auto max-w-3xl px-5 py-16 md:py-24">
          ...
          <P>
            This is the ground Body Belonging Clinic was built to stand on: the serious science of food and the ADHD brain, brought into the room without the diet talk. We hold it inside a wider frame — our{" "}
            ...
            — where food sits alongside your emotion, your focus, your sleep and your nervous system, rather than being treated as a problem to solve on its own. If eating and your ADHD feel tangled together, there is{" "}
            <Link to="/adhd-and-eating" className="underline decoration-[var(--terracotta)] underline-offset-4 hover:text-[var(--terracotta)]">
        ...
        <section className="mx-auto max-w-3xl px-5 py-14">
          ...
          <ul className="mt-8 space-y-4 border-l-2 border-[var(--terracotta)] pl-6 text-base leading-relaxed text-[var(--plum)]/80">
            <li>
              ...
              <a href="https://www.nccih.nih.gov/health/providers/digest/adhd-science" target="_blank" rel="noopener noreferrer" className="underline decoration-[var(--terracotta)] underline-offset-4 hover:text-[var(--terracotta)]">
                ADHD and Complementary Health Approaches: What the Science Says
              </a>.
            </li>
            <li>
              Cochrane Database of Systematic Reviews (2023) — polyunsaturated fatty acids (omega-3/6) for ADHD in children and adolescents.
            </li>
            <li>
              Meta-analysis of randomised controlled trials (2023),{" "}
              <a href="https://pubmed.ncbi.nlm.nih.gov/37656283/" target="_blank" rel="noopener noreferrer" className="underline decoration-[var(--terracotta)] underline-offset-4 hover:text-[var(--terracotta)]">
                Omega-3 Polyunsaturated Fatty Acids for Core Symptoms of ADHD
              </a>, Journal of Clinical Psychiatry.
            </li>
            <li>
              Narrative review (2022),{" "}
              <a href="https://www.mdpi.com/2072-6643/14/20/4332" target="_blank" rel="noopener noreferrer" className="underline decoration-[var(--terracotta)] underline-offset-4 hover:text-[var(--terracotta)]">
                Eating Patterns and Dietary Interventions in ADHD
              </a>, Nutrients.
            </li>
            <li>
              Systematic review (2021),{" "}
              <a href="https://www.mdpi.com/2072-6643/13/11/4059" target="_blank" rel="noopener noreferrer" className="underline decoration-[var(--terracotta)] underline-offset-4 hover:text-[var(--terracotta)]">
                The Role of Iron and Zinc in the Treatment of ADHD
              </a>, Nutrients.
            </li>
            <li>
              Gow, R. (2021),{" "}
              <a href="https://us.jkp.com/products/smart-foods-for-adhd-and-brain-health" target="_blank" rel="noopener noreferrer" className="underline decoration-[var(--terracotta)] underline-offset-4 hover:text-[var(--terracotta)]">
                Smart Foods for ADHD and Brain Health
              </a>, Jessica Kingsley Publishers.
            </li>
          </ul>
        ...
        <section className="mx-auto max-w-3xl px-5 pb-16">
          <div className="rounded-2xl border border-[var(--plum)]/10 bg-[var(--cream)] p-6 text-sm leading-relaxed text-[var(--plum)]/80 md:p-8">
            <p>
              If any of this has stirred something difficult around food, please reach out for support. In an emergency call <strong className="text-[var(--plum)]">000</strong>. For free help any time you can call Lifeline on <strong className="text-[var(--plum)]">13 11 14</strong>, or the Butterfly Foundation&rsquo;s eating disorders line on <strong className="text-[var(--plum)]">1800 33 4673</strong> (1800 ED HOPE).
            </p>
          </div>
        </section>
      </main>
