...
export default defineMcp({
  ...
  version: "0.1.0",
  instructions:
    "Public read-only tools for Body Belonging Clinic (Perth, Australia; telehealth Australia-wide). Use these to answer questions about the clinic, the practitioner Lauren Lynch, booking, the Body Belonging Model, and Australian crisis support lines. The clinic does not diagnose ADHD or prescribe medication. Always state that Medicare rebates MAY apply with an eligible plan — never guaranteed. This is not a crisis service; in an emergency call 000.",
  tools: [
    getClinicInfoTool,
    getPractitionerTool,
    getBookingInfoTool,
